                                ...
                                <form method="post">
                                    <tbody>     
                                        @for($i = 0; $i < count($seller); $i++)
                                            <tr role="row" class="odd" id="validity{{$seller[$i]['userId']}}">
                                                <td>{{$seller[$i]['name']}}</td>
                                                ...
                                                <td><a href="{{route('editSeller',$seller[$i]['userId'])}}" class="btn btn-primary">Edit</a>
                                                    ...
                                                    @else
                                                        <button id="{{$seller[$i]['userId']}}"  type="button" class="btn btn-warning" data-value="{{$seller[$i]['userId']}}" >Unblock</button></td>
                                                    @endif
                                                </td>                                     
                                            </tr>
                                        @endfor
